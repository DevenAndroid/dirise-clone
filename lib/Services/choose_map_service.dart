...
class ChooseAddressService extends StatefulWidget {
  ChooseAddressService({
    super.key,
  });
  static var ChooseAddressServiceScreen = "/ChooseAddressServiceScreen";
  static String route = "/ChooseAddressService";
  @override
  State<ChooseAddressService> createState() => _ChooseAddressServiceState();
}
