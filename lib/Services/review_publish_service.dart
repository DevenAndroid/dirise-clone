              ...
              children: [
                ...
                if(isServiceProvide.value == true)
                  Column(
                    ...
                    children: [
                      ...
                      Text('Price: ${productDetailsModel.value.productDetails!.product!.pPrice??""}'),
                      Text('Make it on sale: ${productDetailsModel.value.productDetails!.product!.discountPercent ?? ''}'),
                      Text('Percentage: ${productDetailsModel.value.productDetails!.product!.id??""}'),
                      Text('Fixed after sale price: ${productDetailsModel.value.productDetails!.product!.fixedDiscountPrice ??""}'),
                    ],
                  ),
                ...
                if(isTellUs.value == true)
                  Column(
                    ...
                    children: [
                      ...
                      Text('Set stock alert: ${productDetailsModel.value.productDetails!.product!.stockAlert ?? ''}'),
                ...
                if(isReturnPolicy.value == true)
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Policy Name: ${productDetailsModel.value.productDetails!.product!.shortDescription??""}'),
                      Text('Return Policy Description : ${productDetailsModel.value.productDetails!.product!.stockAlert??""}'),
                      Text('Return Within: ${productDetailsModel.value.productDetails!.product!.stockAlert ?? ''}'),
                      Text('Return Shipping Fees: ${productDetailsModel.value.productDetails!.product!.seoTags??""}'),
                    ],
                  ),
