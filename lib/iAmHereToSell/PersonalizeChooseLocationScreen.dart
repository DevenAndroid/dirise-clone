...
import 'PersonalizeAddAddressScreen.dart';

class PersonalizeChooseLocation extends StatefulWidget {
  PersonalizeChooseLocation({
    super.key,
  });
  static var chooseAddressScreen = "/chooseAddressScreen";

  @override
  State<PersonalizeChooseLocation> createState() => _PersonalizeChooseLocationState();
}

class _PersonalizeChooseLocationState extends State<PersonalizeChooseLocation> {
