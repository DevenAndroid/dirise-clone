...
class SetTimeScreenExtendedPrograms extends StatefulWidget {
  int? id;
  SetTimeScreenExtendedPrograms({Key? key, this.id}) : super(key: key);
  static var route = "/setTimeScreen";

  @override
  State<SetTimeScreenExtendedPrograms> createState() => _SetTimeScreenExtendedProgramsState();
}

class _SetTimeScreenExtendedProgramsState extends State<SetTimeScreenExtendedPrograms> {
  ...
  timeUpdate() {
    ...
    repositories
      ...
      if (modelCommonResponse.status == true) {
        ...
        if(widget.id != null){
          Get.to(ReviewScreenExtendedPrograms());
        }else{
