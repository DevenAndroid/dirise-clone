...
class ApproveProductScreen extends StatefulWidget {
  static String route = "/ApproveProductScreen";

  const ApproveProductScreen({Key? key}) : super(key: key);

  @override
  State<ApproveProductScreen> createState() => _ApproveProductScreenState();
}
                ...
                child: Obx(() {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      if (!productController.apiLoaded1) {
