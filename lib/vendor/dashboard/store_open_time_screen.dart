    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        return controller.modelStoreAvailability.data != null
          ...
          children: [
            ...controller.modelStoreAvailability.data!.map((e) =>
                Column(
                  children: [
                    Container(
                                  ...
                                  onTap: () {
                                    ...
                                    _showDialog(
                                      CupertinoTimerPicker(
                                        ...
                                        initialTimerDuration: e.startTime
                                            .toString()
                                            .durationTime,
                                        onTimerDurationChanged: (Duration newDuration) {
                                          makeDelay(nowPerform: (bool v) {
                                            String hour =
                                                "${newDuration.inHours < 10 ? "0${newDuration.inHours}" : newDuration
                                                .inHours}";
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    ...
                                    _showDialog(
                                      CupertinoTimerPicker(
                                        mode: CupertinoTimerPickerMode.hm,
                                        initialTimerDuration: e.endTime
                                            .toString()
                                            .durationTime,
                                        onTimerDurationChanged: (Duration newDuration) {
                                          makeDelay(nowPerform: (bool v) {
