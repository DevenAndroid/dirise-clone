...
class AdvirtismentProductScreen extends StatefulWidget {
  ...
  @override
  State<AdvirtismentProductScreen> createState() => _AdvirtismentProductScreenState();
}
...
class _AdvirtismentProductScreenState extends State<AdvirtismentProductScreen> {
  ...
  Rx<AdvirtismentProductModel> modelSingleProduct = AdvirtismentProductModel().obs;
  ...
  getProductDetails() {
    ...
    repositories
        .postApi(url: ApiUrls.advertisingUrl, mapData: {"product_id": id.toString(), "key": 'fedexRate'}).then((value) {
      modelSingleProduct.value = AdvirtismentProductModel.fromJson(jsonDecode(value));
          ...
          child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      if (modelSingleProduct.value.advertisingProduct!.discountOff != '0.00')
                        Container(
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text.rich(
                          TextSpan(
                            text: '${modelSingleProduct.value.advertisingProduct!.discountPrice.toString().split('.')[0]}.',
                            style: const TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      RatingBar.builder(
                        initialRating: double.parse(modelSingleProduct.value.advertisingProduct!.rating.toString()),
                        minRating: 1,
