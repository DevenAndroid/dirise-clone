...
import '../model/vritual_product_model.dart';
...
class VritualProductScreen extends StatefulWidget {
  const VritualProductScreen({super.key});

  // final SingleGiveawayProduct productDetails;
  @override
  State<VritualProductScreen> createState() => _VritualProductScreenState();
}

class _VritualProductScreenState extends State<VritualProductScreen> {
  ...
  Rx<VritualProductModel> modelSingleProduct = VritualProductModel().obs;
  ...
  addToWishList() {
    repositories
        ...
        context: context)
        .then((value) {
      modelSingleProduct.value.singleVirtualProduct!.inWishlist == true;
      ModelCommonResponse response = ModelCommonResponse.fromJson(jsonDecode(value));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        return modelSingleProduct.value.singleVirtualProduct != null
          ...
          child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      if (modelSingleProduct.value.singleVirtualProduct!.discountOff != '0.00')
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                " ${modelSingleProduct.value.singleVirtualProduct!.discountOff}${'%'}  ",
                                style: GoogleFonts.poppins(
                  ...
                  Row(
                    children: [
                      if (modelSingleProduct.value.singleVirtualProduct!.discountOff != '0.00')
                        Expanded(
                          child: Text(
                            'KWD ${modelSingleProduct.value.singleVirtualProduct!.pPrice.toString()}',
                            style: GoogleFonts.poppins(
                                decorationColor: Colors.red,
                                decorationThickness: 2,
                                decoration: TextDecoration.lineThrough,
                      ...
                      Expanded(
                        child: Text.rich(
                          TextSpan(
                            text: '${modelSingleProduct.value.singleVirtualProduct!.discountPrice.toString().split('.')[0]}.',
                            style: const TextStyle(
                              ...
                              WidgetSpan(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        // print("date:::::::::::" + modelSingleProduct.value.singleVirtualProduct!.shippingDate.toString());
                                      },
                                      child: Text(
                                        '${modelSingleProduct.value.singleVirtualProduct!.discountPrice.toString().split('.')[1]}',
                                        style: const TextStyle(
                                            fontSize: 8,
                                            fontWeight: FontWeight.w600,
                                            color: Color(0xFF19313B)),
                  ...
                  SizedBox(
                    height: 28,
                    child: ListView.builder(
                      itemCount: modelSingleProduct.value.singleVirtualProduct!.catId!.length,
                      shrinkWrap: true,
                      scrollDirection: Axis.horizontal,
                        ...
                        return Row(
                          children: [
                            Container(
                              ...
                              child: Text(
                                modelSingleProduct.value.singleVirtualProduct!.catId![index].title.toString(),
                                style: GoogleFonts.poppins(
                  ...
                  //     Expanded(
                  //       child: Text(
                  //         modelSingleProduct.value.singleVirtualProduct!.shippingDate.toString(),
                  //         style: GoogleFonts.poppins(
                  //
                  ...
                  //     ),
                  //     Text(
                  //       modelSingleProduct.value.singleVirtualProduct!.serialNumber.toString(),
                  //       style: GoogleFonts.poppins(
                  //
                  //           color: Colors.grey,
                  //           fontSize: 14,
                  ...
                  //     Expanded(
                  //       child: Text(
                  //         modelSingleProduct.value.singleVirtualProduct!.lowestDeliveryPrice == ""
                  //             ? "0"
                  //             : modelSingleProduct.value.singleVirtualProduct!.lowestDeliveryPrice.toString(),
                  //         style:
                  //         GoogleFonts.poppins(color: const Color(0xFF014E70), fontSize: 14, fontWeight: FontWeight.w500),
                  //       ),
                  //     ),
                  ...
                  Row(
                    ...
                    children: [
                      Flexible(
                        child: Text(
                          modelSingleProduct.value.singleVirtualProduct!.storemeta!.storeName.toString(),
                          style: GoogleFonts.poppins(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w500),
                        ),
                      ),
                      const SizedBox(
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        modelSingleProduct.value.singleVirtualProduct!.storemeta!.storeLocation.toString(),
                      ...
                      Text(
                        modelSingleProduct.value.singleVirtualProduct!.storemeta!.storeCategory.toString(),
                  ...
                  Center(
                    child: CachedNetworkImage(
                        imageUrl:
                        modelSingleProduct.value.singleVirtualProduct!.storemeta!.document2.toString(),
                        height: 180,
                        fit: BoxFit.cover,
                        errorWidget: (_, __, ___) => Image.asset('assets/images/new_logo.png')),
                  ):SizedBox.shrink(),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    maxLines: 2,
                                    style: GoogleFonts.poppins(
                                        fontSize: 12, fontWeight: FontWeight.w500, color: const Color(0xFF19313C)),
                                  ),
