...
class _VarientsProductScreenState extends State<VarientsProductScreen> {
  ...
  getProductDetails() {
    ...
    map['key'] = 'fedexRate';
    repositories
        .postApi(url: ApiUrls.varientsUrl, mapData: map).then((value) {
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text.rich(
                          TextSpan(
                            text: '${modelSingleProduct.value.variantProduct!.discountPrice.toString().split('.')[0]}.',
                            style: const TextStyle(
                              ...
                              WidgetSpan(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      onTap: () {
                                        print("date:::::::::::" + modelSingleProduct.value.variantProduct!.shippingDate.toString());
                                      },
                                      child: Text(
